...
public class DownloadFile extends Thread {
    ...
    public static void main(String[] args) {
        try {
            download(new URL("http://www.postgresql.org/files/documentation/pdf/9.0/postgresql-9.0-A4.pdf"));
    ...
    public void run() {
        ...
        try {
            ...
            RandomAccessFile oSavedFile = new RandomAccessFile("D:/bbb.pdf", "rw");
